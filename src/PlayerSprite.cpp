...
PlayerSprite::PlayerSprite(SDL_Renderer* pRenderer, SDL_Surface& surface, unsigned nrSprites)
: SpriteAnimator(20) {
	m_atlassedSprite = std::make_shared<vo::AtlassedSpriteU>(pRenderer, surface, nrSprites);
